...
<body>
  ...
  <div class="content__top">
           ...
           <span>></span>
           <a href="./content__sanPham.php">Giày dép</a>
           <span>></span>
           <a href="#">dép</a>
   </div>
   <div class="content">
       ...
       <div id="one" class="img">
        <img src="../img/icon_nho/30.jpg" alt="">
      </div>
      <div id="two" class="img" style="display:none">
        <img src="../img/icon_nho/30.jpg">
      </div>
      ...
      <div class=" w3-black">
        <img src="../img/icon_nho/30.jpg" onclick="openCity('one')">
        <img src="../img/icon_nho/30.jpg" width="50px" height="50px" alt="" onclick="openCity('two')">
        <img src="../img/icon_nho/30.jpg" width="50px" height="50px" alt="" onclick="openCity('there')">
        <img src="../img/icon_nho/30.jpg" width="50px" height="50px" alt="" onclick="openCity('4')">
        <img src="../img/icon_nho/30.jpg" width="50px" height="50px" alt="" onclick="openCity('5')">
      </div>
       </div>
       <div class="content__right">
           <h3><span id = "yt">Yêu thích</span>Hàng cao cấp , dép nam , dép nữ</h3>
            <h1>₫239.000</h1>
