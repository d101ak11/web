  ...
  <div class="content__top">
   ...
   <div class="content">
       ...
       <div id="one" class="img">
        <img src="../img/icon_nho/32.jpg" alt="">
      </div>
      <div id="two" class="img" style="display:none">
        <img src="../img/icon_nho/32.jpg">
      </div>
      ...
      <div class=" w3-black">
        <img src="../img/icon_nho/32.jpg" onclick="openCity('one')">
        <img src="../img/icon_nho/32.jpg" width="50px" height="50px" alt="" onclick="openCity('two')">
        <img src="../img/icon_nho/32.jpg" width="50px" height="50px" alt="" onclick="openCity('there')">
        <img src="../img/icon_nho/32.jpg" width="50px" height="50px" alt="" onclick="openCity('4')">
        <img src="../img/icon_nho/32.jpg" width="50px" height="50px" alt="" onclick="openCity('5')">
      </div>
       </div>
       <div class="content__right">
           <h3><span id = "yt">Yêu thích</span>Áo Thun Nam, Nữ Rộng , Unisex Basic Cotton </h3>
            <h1>₫239.000</h1>
